...
writer1 = SummaryWriter('runs/TransE_loss_porto_266/train')
writer2 = SummaryWriter('runs/TransE_loss_porto_266/valid')
...
def train(args):
    ...
    # create dataset
    dataset_path = os.path.join(DATA_PATH, args.dataset)    #创建数据集
...
parser.add_argument(
    "--dataset", default="bj_xiaorong_wo_borough", choices=["NYC", "CHI","porto",'bj'],
