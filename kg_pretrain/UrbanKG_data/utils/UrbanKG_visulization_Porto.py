...
######################################
# dataframe2 = gpd.read_file('../Meta_data/porto/Administrative_data/Area/porto_area.shp')
#
# dataframe2 = dataframe2.to_crs('EPSG:4326')
# seleceted_colums2 = ['ID', 'NAME_3', 'geometry']
...
################### borough #######################
m_borough = folium.Map(location=[41,-8.5], zoom_start=10, tiles="cartodbpositron")
...
m_borough.save('borough_Porto.html')

# ############################### area ################################
# m_area = folium.Map(location=[-8.5,41], zoom_start=10, tiles="cartodbpositron")
#
...
m_POI = folium.Map(location=[41, -8.5], zoom_start=10, tiles="cartodbpositron")
