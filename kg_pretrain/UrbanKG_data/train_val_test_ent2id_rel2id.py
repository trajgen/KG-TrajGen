...
def produce_train_val_test(KG, entity2id, realtion2id, triple):
    ...
    with open(entity2id) as f:
        for line in f.readlines():
            temp = line.split()
            entity_category_dict.update({temp[0] : temp[1]}) #键值对
...
if __name__ == "__main__":
    KG_porto = "./xiaorong/porto/wo_area/UrbanKG_augmented_porto_wo_area.txt"
    entity2id_porto = "./xiaorong/porto/wo_area/entity2id_porto.txt"
    relation2id_porto = "./xiaorong/porto/wo_area/relation2id_porto.txt"
    triple_porto = "./xiaorong/porto/wo_area/triplets_porto.txt"
    train_porto = './xiaorong/porto/wo_area/train_porto.txt'
    valid_porto = './xiaorong/porto/wo_area/valid_porto.txt'
    test_porto = './xiaorong/porto/wo_area/test_porto.txt'

    get_entity2id_relation2id(KG_porto, entity2id_porto, relation2id_porto)
    produce_train_val_test(KG_porto, entity2id_porto, relation2id_porto, triple_porto)
    get_train_val_test(triple_porto, train_porto, valid_porto, test_porto)
